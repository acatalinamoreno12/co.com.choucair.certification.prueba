...
Feature: Registro de Usuario en la pagina web de Utest
  ...
  Scenario: Registro de Angie en la pagina web de Utest
    ...
    When El usuario ingresa la informacion solicitada en la pagina para su correcto registro
      ...
      | strNombre | strApellido | strCorreo                  | strMesNacimiento | strDiaNacimiento | strAnoNacimiento | strCiudad | strCodigoPostal | strPais  | strPC   | strVersion | strIdioma | strDispositivoMovil | strModelo | strSO       | strContrasena  | strConfirmarContrasena |
